...
export const MobileBottomDock = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-4 py-3 bg-card/95 backdrop-blur-xl border border-border/50 rounded-full shadow-2xl">
        {dockItems.map((item) => {
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-full bg-primary/30 -z-10 blur-md"
