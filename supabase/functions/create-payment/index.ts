      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: { 
              name: "Premium Access - InvestEd Platform",
              description: "Unlock premium features including advanced portfolio analysis, unlimited ELIN chat, and exclusive market insights"
            },
